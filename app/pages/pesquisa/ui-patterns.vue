      ...
      <div class="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div class="lg:col-span-7 lg:col-start-6 space-y-8">
            ...
            <!-- Section: Navegação -->
            <section id="navegacao" class="scroll-mt-32 bg-surface-card border border-border-subtle r rounded-lgounded-lg p-8 shadow-sm">
              <h2 class="text-2xl font-light text-text-primary mb-6">Padrões de Navegação</h2>
              
              <div class="bg-surface-subtle p-8 border border-border-hairline r rounded-lgounded-lg mb-8">
              ...
              <div class="space-y-6">
                <div class="bg-surface-subtle p-6 border border-border-hairline r rounded-lgounded-lg">
            ...
            <!-- Section: Cards -->
            <section id="cards" class="scroll-mt-32 bg-surface-card border border-border-subtle r rounded-lgounded-lg p-8 shadow-sm">
            ...
            <!-- Section: Filtros -->
            <section id="filtros" class="scroll-mt-32 bg-surface-card border border-border-subtle r rounded-lgounded-lg p-8 shadow-sm">
            ...
            <!-- Section: Galerias -->
            <section id="galerias" class="scroll-mt-32 bg-surface-card border border-border-subtle r rounded-lgounded-lg p-8 shadow-sm">
