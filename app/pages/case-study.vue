...
<template>
  <div class="min-h-screen bg-mat-stone text-off-white selection:bg-action-primary selection:text-deep-brown">
    <!-- Header -->
    <header class="bg-mat-stone border-b border-off-white/10">
      <div class="max-w-[1400px] mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
        <div class="flex items-center gap-4">
          ...
          <nav class="flex items-center gap-2 text-xs font-mono tracking-widest uppercase">
            ...
            <span class="text-off-white">Case Study</span>
          </nav>
        </div>
    ...
    <!-- Navigation -->
    <nav class="fixed bottom-0 left-0 right-0 bg-mat-stone/80 backdrop-blur-md border-t border-off-white/10">
